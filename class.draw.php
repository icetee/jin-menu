...
function start_el(&$output, $item, $depth, $args) {
    ...
    <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
            <?php if( 'custom' == $item->type || 'Custom Link' == $item->type  ) : ?>
...
if($item->type_label=="Custom" || $item->type_label=="Custom Link"){
            ?>      
...
<textarea id="edit-menu-item-jin-<?php echo $item_id; ?>" class="widefat code edit-menu-item-jin" name="menu-item-jin[<?php echo $item_id; ?>]" >
<?php 
if($value) echo esc_html($value) ; else echo esc_attr( $item->jin ); ?>
</textarea>
                </label>
            </p>
            <?php
...
class draw extends Walker_Nav_Menu_Edit_Jin {
		...
		function __construct()   {
			...
			function jin_nav_update($menu_id, $menu_item_db_id, $args ) {
				if ( is_array($_REQUEST['menu-item-jin']) && isset($_REQUEST['menu-item-jin'][$menu_item_db_id])  ) {
